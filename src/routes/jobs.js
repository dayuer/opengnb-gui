 ...
 * @alpha: 核心路由
 */
function createJobsRouter({ jobManager, sshManager, keyManager, requireAuth, broadcastWS }) {
   ...
   */
  router.post('/:jobId/callback', express.json({ limit: '256kb' }), (req, res) => {
   ...
   * Body: { nodeId, command }
   */
  router.post('/dispatch', requireAuth, express.json(), async (req, res) => {
