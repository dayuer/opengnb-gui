...
function createEnrollRouter(keyManager: any, security: any = {}) {
   ...
   */
  const requireEnrollToken = (req: any, res: any, next: any) => {
   ...
   */
  const requireNodeIdMatch = (req: any, res: any, next: any) => {
  ...
  router.get('/address-conf', requireEnrollToken, (req: any, res: any) => {
  ...
  router.post('/', enrollLimit, (req: any, res: any) => {
  ...
  const flexAuthStatus = (req: any, res: any, next: any) => {
    const authHeader = req.headers.authorization;
    if (!authHeader || !authHeader.startsWith('Bearer ')) {
  ...
  router.get('/status/:id', flexAuthStatus, (req: any, res: any) => {
  ...
  router.post('/:id/ready', requireEnrollToken, requireNodeIdMatch, (req: any, res: any) => {
  ...
  router.get('/gnb-pubkey', (req: any, res: any) => {
  ...
  router.post('/:id/gnb-pubkey', requireEnrollToken, requireNodeIdMatch, (req: any, res: any) => {
  ...
  router.get('/passcode', ...adminMiddleware, (req: any, res: any) => {
  ...
  router.post('/batch', ...adminMiddleware, (req: any, res: any) => {
  ...
  router.patch('/:id/group', ...adminMiddleware, (req: any, res: any) => {
  ...
  const clawTokenAuth = (req: any, res: any, next: any) => {
    // 先尝试 enrollToken
    const authHeader = req.headers.authorization;
    if (authHeader && authHeader.startsWith('Bearer ')) {
      const token = authHeader.slice(7);
  ...
  router.post('/:id/claw-token', clawTokenAuth, (req: any, res: any) => {
